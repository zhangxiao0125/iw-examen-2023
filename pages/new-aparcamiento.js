...
const CreateHousing = ({loggedUser}) => {
	...
	const handleSubmit = async() => {
		await fetch(`http://${process.env.URL}/api/aparcamientos`,{
			body: JSON.stringify({
	...
	return (
		<>
			...
			<div className="flex-col flex w-full h-screen space-y-4 mt-10 items-center" >
				...
				<h1 className="text-2xl font-normal ">Crear aparcamiento</h1>
				<form onSubmit={handleSubmit} action={`http://${process.env.URL}/aparcamientos`}>
